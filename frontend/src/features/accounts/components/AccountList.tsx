...
import AccountCardsModal from './AccountCardsModal'
              ...
              <Table.Tr key={acc.id}>
                ...
                <Table.Td className="text-right">
                  <div className="flex justify-end gap-2">
                    <Button size="sm" variant="ghost" onClick={() => setCardsAccount(acc)}>Cartões</Button>
                    <Button size="sm" variant="ghost" onClick={() => openEdit(acc)}>Editar</Button>
                    <Button size="sm" variant="danger" onClick={() => remove(acc.id)}>Excluir</Button>
                  </div>
                </Table.Td>
              </Table.Tr>
            ))}
